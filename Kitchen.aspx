<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Kitchen.aspx.vb" Inherits="Kitchen" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/Kitchen1.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 276px; top: 1029px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="5L"></asp:Label>
        <asp:Label ID="Label9" runat="server" 
            style="z-index: 1; left: 910px; top: 1022px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="3L"></asp:Label>
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 192px; top: 571px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; right: 1201px;" 
            Text="10L"></asp:Label>
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 902px; top: 1466px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="3L"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 316px; top: 1481px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1518px; right: 1077px;" 
            Text="8L"></asp:Label>
        </div>
    </form>
    <p>

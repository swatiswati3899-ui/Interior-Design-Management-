<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WallHangings.aspx.vb" Inherits="WallHangings" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/Hang1.jpg" BorderColor="Black" BorderStyle="Solid" 
...
&nbsp;&nbsp;&nbsp;
        <asp:Image ID="Image3" runat="server" 
            ...
            ImageUrl="~/Photos/Hang5.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image4" runat="server" 
            
            
            style="z-index: 1; left: 22px; top: 1085px; position: absolute; width: 593px; height: 439px; margin-right: 0px;" 
            ImageUrl="~/Photos/Hang7.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image5" runat="server" 
            
            
            style="z-index: 1; left: 20px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/Hang2.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image6" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 1083px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/Hang6.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image7" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/Hang4.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Label ID="Label2" runat="server" 
            style="z-index: 1; left: 872px; top: 564px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="70K" ForeColor="White"></asp:Label>
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 176px; top: 1030px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; right: 1217px;" 
            Text="50K" ForeColor="White"></asp:Label>
        <asp:Label ID="Label9" runat="server" 
            style="z-index: 1; left: 868px; top: 1030px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="80K" ForeColor="White"></asp:Label>
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 278px; top: 575px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="5L" ForeColor="White"></asp:Label>
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 908px; top: 1470px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="80K"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 282px; top: 1474px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1511px;" 

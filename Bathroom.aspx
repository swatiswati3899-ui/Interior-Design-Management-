<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bathroom.aspx.vb" Inherits="Bathroom" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/Bath1.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 342px; top: 1023px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; right: 1051px;" 
            Text="1.5L"></asp:Label>
        ...
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 245px; top: 557px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="1L" ForeColor="White"></asp:Label>
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 878px; top: 1460px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="80K"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 301px; top: 1479px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1516px;" 
            Text="90K"></asp:Label>
        </div>
    </form>
    <p>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewReject.aspx.vb" Inherits="ViewReject" %>
...
<body style="font-family: 'Footlight MT Light'; height: 709px; width: 1181px;" 
    bgcolor="#f9d9b3">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        style="z-index: 1; left: 162px; top: 197px; position: absolute; height: 401px; width: 770px">
    ...
    <a href="ApprovalList1.aspx"><span class="style1">ApprovalList1.aspx</span></a><asp:SqlDataSource ID="SqlDataSource1" runat="server" 

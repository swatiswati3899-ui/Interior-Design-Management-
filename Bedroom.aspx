<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bedroom.aspx.vb" Inherits="Bedroom" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/Bed1.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 254px; top: 1029px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="3L"></asp:Label>
        <asp:Label ID="Label9" runat="server" 
            style="z-index: 1; left: 909px; top: 1026px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="5L"></asp:Label>
        ...
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 882px; top: 1473px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="90K"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 322px; top: 1479px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1516px; right: 1071px;" 
            Text="4L"></asp:Label>
        </div>
    </form>
    <p>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Balcony.aspx.vb" Inherits="Balcony" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/B1.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Image ID="Image3" runat="server" 
            ...
            ImageUrl="~/Photos/B7.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image4" runat="server" 
            
            
            style="z-index: 1; left: 22px; top: 1085px; position: absolute; width: 593px; height: 439px; margin-right: 0px;" 
            ImageUrl="~/Photos/B5.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image5" runat="server" 
            
            
            style="z-index: 1; left: 20px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/B3.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image6" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 1083px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/B6.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image7" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/B4.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Label ID="Label2" runat="server" 
            style="z-index: 1; left: 925px; top: 570px; position: absolute; width: 92px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="80K"></asp:Label>
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 247px; top: 1022px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="60K"></asp:Label>
        <asp:Label ID="Label9" runat="server" 
            style="z-index: 1; left: 890px; top: 1020px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="20K"></asp:Label>
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 260px; top: 570px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="1L"></asp:Label>
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 956px; top: 1468px; position: absolute; width: 137px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="70K"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 260px; top: 1471px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1508px;" 
            Text="25K"></asp:Label>
        </div>
    </form>
    <p>

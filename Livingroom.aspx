<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Livingroom.aspx.vb" Inherits="Livingroom" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/L7.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Image ID="Image3" runat="server" 
            ...
            ImageUrl="~/Photos/L2.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image4" runat="server" 
            
            
            style="z-index: 1; left: 22px; top: 1085px; position: absolute; width: 593px; height: 439px; margin-right: 0px;" 
            ImageUrl="~/Photos/L3.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image5" runat="server" 
            
            
            style="z-index: 1; left: 20px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/L5.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image6" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 1083px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/L6.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image7" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/L4.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Label ID="Label2" runat="server" 
            style="z-index: 1; left: 876px; top: 568px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="15L"></asp:Label>
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 230px; top: 1025px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="10L"></asp:Label>
        <asp:Label ID="Label9" runat="server" 
            style="z-index: 1; left: 897px; top: 1029px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="16L"></asp:Label>
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 192px; top: 571px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="20L" ForeColor="White"></asp:Label>
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 908px; top: 1472px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="12L"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 253px; top: 1475px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: -1512px;" 
            Text="18L"></asp:Label>
        </div>
    </form>
    <p>

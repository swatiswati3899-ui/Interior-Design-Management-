<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UnblockMsg.aspx.vb" Inherits="UnblockMsg" %>
...
<body style="font-family: 'Footlight MT Light'; height: 474px; width: 1173px; margin-right: 4px; margin-bottom: 0px;" 
    background="white" bgcolor="#009999"> 
    <form id="form1" runat="server">
    <div style="height: 0px; width: 1495px">
        ...
        <asp:Label ID="Label1" runat="server" 
            style="z-index: 1; left: 99px; top: 277px; position: absolute; font-size: xx-large; font-weight: 700;" 
            Text="The Record has been Sent Back Successfully" BorderColor="Red" 
            BorderStyle="Inset" BorderWidth="4px" ForeColor="Black"></asp:Label>

...
Partial Class BillingDetails
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ' conn.Open()
        Dim cmd2 As New SqlCommand("insert into BillingTab(OrderID,Name,Address,Contact,Email,Item,Shape,Color,Price,Discount,Total,Payment)Values('" & DropDownList1.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & TextBox7.Text & "','" & TextBox8.Text & "','" & TextBox9.Text & "','" & TextBox10.Text & "','" & DropDownList2.Text & "')", conn)
    ...
    Protected Sub Butshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Butshow.Click
        'conn.Open()
        TextBox1.Text = ""
        Dim cmd1 As New SqlCommand("Select Name,Address,Contact,Email,Item,Shape,Color from OrderTab where OrderID='" & DropDownList1.Text & "'", conn)
    ...
    Protected Sub Button5_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button5.Click
        TextBox9.Text = Val(TextBox8.Text) * 0.1

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Poojaroom.aspx.vb" Inherits="Poojaroom" %>
...
<body style="font-family: 'Footlight MT Light'; height: 1540px; width: 1236px; margin-bottom: 3px;" 
    ...
    <div style="height: 15px; width: 1495px">
        ...
        <asp:Image ID="Image2" runat="server" 
            ...
            ImageUrl="~/Photos/Pooja_5.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Image ID="Image3" runat="server" 
            ...
            ImageUrl="~/Photos/Po1.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        ...
        <asp:Image ID="Image5" runat="server" 
            ...
            ImageUrl="~/Photos/Po5.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image6" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 1083px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/Po3.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        <asp:Image ID="Image7" runat="server" 
            
            
            style="z-index: 1; left: 630px; top: 633px; position: absolute; width: 595px; height: 439px" 
            ImageUrl="~/Photos/Po6.jpg" BorderColor="Black" BorderStyle="Solid" 
            BorderWidth="2px" />
        ...
        <asp:Label ID="Label8" runat="server" 
            style="z-index: 1; left: 176px; top: 1030px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="2L"></asp:Label>
        ...
        <asp:Label ID="Label11" runat="server" 
            style="z-index: 1; left: 766px; top: 1470px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large" 
            Text="1.2L"></asp:Label>
        <asp:Label ID="Label12" runat="server" 
            style="z-index: 1; left: 198px; top: 1478px; position: absolute; width: 202px; height: 38px; font-weight: 700; font-size: x-large; bottom: 646px;" 
            Text="50L"></asp:Label>
        </div>
    </form>
    <p>
